...
// of header/footer
static inline size_t get_value(void *ptr)
{
    return *(size_t *)ptr;
}
// Writes size to header/footer
static inline void write_size(void *ptr, size_t size)
{
    *(size_t *)ptr = size;
}
